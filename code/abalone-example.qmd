...
H~0~: **There's no effect of pH on abalone growth.**  
...
# creating new object from original data set "abalone"
...
# base lyaer: ggplot
ggplot(data = abalone_clean, # using the cleaned data frame
       aes(x = mean_ph, # x-axis: mean pH
           y = change_in_area)) + # y-axis: change in shell surface area
...
**The missing value comes from a apri of tanks in which the pH sensor malfunctioned, leaving no reading from those tanks.**  
